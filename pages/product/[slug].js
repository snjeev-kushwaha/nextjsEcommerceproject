            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/41mHIbG5gaL.jpg" />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900">₹5800</span>
                            ...
                            <div className="pin mt-6 flex space-x-2 text-sm">
                                <input className='px-2 border-2 border-gray-400 rounded-md' placeholder='Enter your Pincode' type="text" onChange={onChangePin} />
                            ...
                            {(!service && service != null) && <div className="text-red-700 text-sm mt-3">
                                Sorry! Wo do not deliver to this pincode yet
                            </div>}
